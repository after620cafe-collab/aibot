...
class Voice(commands.Cog):
    ...
    @commands.hybrid_command(name="joinvc", aliases=["join","voicemode"])
    ...
    @commands.hybrid_command(name="leavevc", aliases=["leave"])
    ...
    @commands.hybrid_command(name="t", aliases=["tts","speak"])
    ...
    @commands.hybrid_command(name="voicekick", aliases=["vckick","vcdisconnect"])
    ...
    @commands.hybrid_command(name="voiceunmute", aliases=["vcunmute"])
    @commands.has_permissions(mute_members=True)
